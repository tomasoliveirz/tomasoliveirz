...
- **Final grade:** 18/20
- **Highlights:** hybrid code generation (Scriban templates + builder patterns), validation for conflicting configs, OpenZeppelin-based foundations
- **Stack:** C#/.NET, Scriban, Solidity 0.8.x, React + TypeScript
- **My contribution:** builder-pattern integration + template engine work (the parts where “dynamic logic” gets messy fast)
- **Repo (public mirror):** https://github.com/tomasoliveirz/Launchpad_Gen-Public

> Note: this repo is a public mirror of the original project. Some company/academic context remains private, but the core implementation and documentation are here.
...
- **Stack:** React + Vite, Node.js, Prisma, SQLite (prod), Nginx + PM2
- Repo: https://github.com/tomasoliveirz/santhyago-breakfast-web

### PomoPomo
A real-time collaborative Pomodoro app (rooms, synced sessions, tasks).

- **Stack:** Next.js, Socket.io, PostgreSQL, Redis, Docker
- Repo: https://github.com/tomasoliveirz/pomopomo
- Live: https://pomopomo.site

### AquaHub (DigiWater)
A comprehensive water quality monitoring application.

- **Stack:** Flutter, Dart, Supabase
- **Get it on Google Play:** https://play.google.com/store/apps/details?id=com.company.digiwater&pli=1
